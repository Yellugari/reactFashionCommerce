        ...
        <div className='topnavrow row'>
          ...
          */}
          <div className='cart-wishlist'>
           ...
           <li className="list-icon" > <Link to="/cart"> {cartItemCount>0 && <div className='cart-item-count'><p>{cartItemCount}  <FontAwesomeIcon icon="fa fa-shopping-cart"  style={{color:"white"}}></FontAwesomeIcon></p></div>}</Link> </li>
